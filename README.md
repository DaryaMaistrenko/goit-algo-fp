...
Після виконання симуляцій (наприклад, 100,000 кидків) ми отримали ймовірності для кожної можливої суми:
...
*Примітка: Замініть `X`, `Y`, `Z`, тощо, на фактичні значення ймовірностей, отриманих з симуляції.*
...
- Для покращення точності результатів рекомендовано проводити більше симуляцій, наприклад, 1,000,000 кидків.
